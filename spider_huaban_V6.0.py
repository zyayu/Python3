...
def get_dir_name(url_path):
    ...
    div_list = soup.find_all('div', {'class': "categories"})
    # li_list = div_list.fine_all('li')
    print(div_list)
    # dir_name = []
    # img_album_url = []
    # for div in div_list:
...
def main():
    ...
    主函数
    """
    url_path = 'https://huaban.com/discovery'
    # 获取分类的名称，并输出进行选择爬取
    dir_name_list = get_dir_name(url_path)
    # print("请选择需要下载图片的分类{}：".format(category))
